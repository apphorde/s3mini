...
- Add peer registration and dead-letter handling. Replication events now use SQLite leases with expiry so concurrent workers do not deliver the same event simultaneously, and crashed workers can be recovered.
