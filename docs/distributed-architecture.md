...
- Peer health is persisted in SQLite and exposed through the admin control plane; PUT delivery validates MD5 ETags and SHA-256 digests, and inventory repair compares ETags. Stronger inventory hash comparison remains future work.
