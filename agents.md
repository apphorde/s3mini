...
- Next implementation slice: integrate OIDC dashboard login, evaluate the Li3 UI modernization, and extend SHA-256 validation to inventory comparisons and older event migration paths. Initial geolocated test nodes may connect over private VPN endpoints; keep secrets in environment variables.
