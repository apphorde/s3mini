...
- Next implementation slice: add retry leasing/dead-letter handling and strengthen content-hash verification. Initial geolocated test nodes may connect over private VPN endpoints; keep secrets in environment variables.
