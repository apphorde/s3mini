...
- Next implementation slice: anti-entropy repair and peer health state. Initial geolocated test nodes may connect over private VPN endpoints; keep secrets in environment variables.
